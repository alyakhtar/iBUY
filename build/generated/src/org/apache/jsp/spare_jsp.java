...
public final class spare_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<span class=\"icon-bar\"></span>\t\t\t\t\n");
      out.write("\t\t\t\t</button>\n");
      out.write("\t\t\t\t<a class=\"navbar-brand \" href=\"home.html\">ibuy</a>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t    \t<br><br>\n");
      out.write("\t\t    \t<table border=\"3\" style=\"width:80%\">\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t    \t<td>NAME : </td>\n");
      out.write("\t\t\t\t    \t<td>WOHOO</td>\t\t\t\t    \t\n");
      out.write("\t\t\t\t  \t</tr>\n");
      out.write("\t\t\t\t  \t<tr>\n");
      out.write("\t\t\t\t   \t\t<td>PHONE NUMBER : </td>\n");
      out.write("\t\t\t\t    \t<td>8800739044</td>\n");
      out.write("\t\t\t\t  </tr>\n");
      out.write("\t\t\t\t  <tr>\n");
      ...
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"User Name\"></p>\t\t\t\n");
      out.write("          \t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\n");
      out.write("                                                <p><input type=\"submit\" class=\"btn btn-danger\" name=\"admin\" value=\"Delete\" style=\"margin-left:290px\"></p>\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t</form> \n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">x</button>\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<h4>Enter Order Numbere</h4>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\n");
      ...
      out.write("\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">x</button>\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<h4>Enter Comment Id</h4>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\n");
      out.write("            \t\t\t\t\t<form method=\"post\" action='' name=\"login_form\">\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"Comment Number\"></p>\t\t\t              \t\t\t\n");
      out.write("            \t\t\t\t\t</form>\n");
      out.write("          \t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\n");
      out.write("\t\t\t\t\t\t<a class=\"btn btn-danger\">DELETE</a>\n");
      ...
      out.write("\t\t\t\t\t<div class=\"modal-body\">\n");
      out.write("            \t\t\t\t\t<form method=\"post\" action='' name=\"login_form\">\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"ITEM NAME\"></p>\t\t\t              \t\t\t\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"PRICE\"></p>\t\t\t              \t\t\t\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"SPECIFICATIONS\"></p>\t\t\t              \t\t\t\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"ACCESSORIES\"></p>\t\t\t              \t\t\t\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"IMAGE PATH\"></p>\n");
      out.write("\t\t\t              \t\t\t<p><input type=\"text\" class=\"span3\" name=\"eid\" id=\"user\" placeholder=\"AVAILABILITY\"></p>\t          \t\t\t\n");
      out.write("            \t\t\t\t\t</form>\n");
      out.write("          \t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\n");
      out.write("\t\t\t\t\t\t<a class=\"btn btn-danger\">ADD</a>\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t</form> \n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("          \t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\n");
      out.write("\t\t\t\t\t\t<a class=\"btn btn-danger\">VIEW</a>\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t</form> \n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("              \t\t\t\t\t\t<p><button type=\"submit\" class=\"btn btn-primary\">ADD USER</button></p>\n");
      out.write("            \t\t\t\t\t</form>\n");
      out.write("          \t\t\t\t</div>\n");
